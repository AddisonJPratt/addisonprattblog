...
\end{large}
\vspace{-0.16cm}
* Designed and implemented advanced machine learning models to predict voter behaviors, achieving an accuracy rate of over 90%, aiding in the formulation of targeted strategies for 25 campaigns and 22 states.
* Innovated an advanced R script to automate report generation from a SQL database, eliminating manual data entry and significantly boosting departmental productivity by 97%.
...
\end{large}
\vspace{-0.16cm}
* **Biostatistics**: Tutored 41 students basic statistical analyses, theories, and methods with Excel.
* **Applied Math with Excel**: Tutored 35 students to identify real-world situations (e.g. financial, family, social, or community issues) where quantitative reasoning skills are needed to inform a decision.
\vspace{6pt}
...
\vspace{2pt}
* **Other Technical Skills**: SQL, C#, ArcGIS, Microsoft Office, Git/GitHub, Statistical Analysis, Data Wrangling, Spanish
\vspace{2pt}
